...
@interface FeedSharePlayComponent ()<UITableViewDelegate, UITableViewDataSource, FeedShareMessageComponentDelegate>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, copy) NSArray<FeedShareVideoModel*> *dataArray;
...
@implementation FeedSharePlayComponent

- (instancetype)initWithRoomModel:(FeedShareRoomModel *)roomModel {
    if (self = [super init]) {
        self.roomModel = roomModel;
        self.isHost = [roomModel.hostUid isEqualToString:[LocalUserComponent userModel].uid];
