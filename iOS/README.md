...
1. 打开终端窗口，进入 `FeedshareDemo/iOS/veRTC_Demo_iOS` 根目录<br>
...
3. 进入 `FeedshareDemo/iOS/veRTC_Demo_iOS` 根目录，使用 Xcode 打开 `veRTC_Demo.xcworkspace`<br>
...
7. 填写 **Partner** 和 **Category**<br>
    打开`Pods/Development Pods/FeedShareDemo/FeedShareDemoConstants.h` 文件，使用获取的 **Partner** 和 **Category** 填写到对应位置。<br>
