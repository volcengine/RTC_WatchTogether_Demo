...
public class FeedShareRTSClient extends RTSBaseClient {
    ...
    private static final String CMD_RECONNECT = "twReconnect";
    ...
    public void reconnectToServer(String roomId, IRequestCallback<RTSBizResponse> callback) {
        AppExecutors.networkIO().execute(() -> {
            JsonObject params = getCommonParams(CMD_RECONNECT);
            sendServerMessage(CMD_RECONNECT, roomId, params, RTSBizResponse.class, callback);
        });
    }
